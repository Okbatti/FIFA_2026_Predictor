...
st.markdown(
    ...
    "[data-testid='stMain'] .block-container{position:relative;z-index:2;max-width:1180px;margin:0 auto;padding-top:2.2rem;}"
    ...
    ".rail{position:fixed;top:0;bottom:0;width:clamp(0px,calc((100vw - 1220px)/2),300px);z-index:1;pointer-events:none;display:flex;flex-direction:column;align-items:center;justify-content:space-between;padding:46px 0;overflow:hidden;}"
